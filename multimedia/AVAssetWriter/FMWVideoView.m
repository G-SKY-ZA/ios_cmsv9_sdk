...
-(instancetype)initWithFMVideoViewType:(FMVideoViewType)type videoName:(NSString*)videoName
{
    
    self = [super initWithFrame:[UIScreen mainScreen].bounds];
    if (self) {
        [self BuildUIWithType:type videoName:videoName];
    }
    return self;
}

#pragma mark - view
- (void)BuildUIWithType:(FMVideoViewType)type videoName:(NSString *)videoName
{
    
    self.fmodel = [[FMWModel alloc] initWithFMVideoViewType:type superView:self videoName:videoName];
...
//    if (Is_Iphone_X) {
//        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, IphoneX_StatusBar_Top)];
//        view.backgroundColor = [UIColor blackColor];
//        [self addSubview:view];
//      self.topView.frame = CGRectMake(0,IphoneX_StatusBar_Top , kScreenHeight, 44);
//    }else{
          self.topView.frame = CGRectMake(0, 0, bounds.size.width, 44);
//    }
...
//    if (Is_Iphone_X) {
//    self.timeView.frame = CGRectMake((kScreenWidth - 100)/2, 16 + IphoneX_StatusBar_Top , 100, 34);
//    }else{
       self.timeView.frame = CGRectMake((bounds.size.width - 100)/2, 16, 100, 34);
//    }
    ...
    self.turnCamera.frame = CGRectMake(bounds.size.width - 60 - 28, 11, 28, 22);
    ...
    self.flashBtn.frame = CGRectMake(bounds.size.width - 22 - 15, 11, 22, 22);
    ...
    self.progressView = [[FMRecordProgressView alloc] initWithFrame:CGRectMake((bounds.size.width - 62)/2, bounds.size.height - 32 - 62, 62, 62)];
